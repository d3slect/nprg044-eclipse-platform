...
public class Example00 {
	...
	public static void main(String[] args) {
		...
		// widget for specifying numeric values that has small arrow buttons (increment, decrement)
		...
		spinner.addSelectionListener(new SelectionAdapter() {
				...
				public void widgetSelected(SelectionEvent e) {			
					if (e.widget == spinner) {
						// modify the list content based on the value defined in the spinner
