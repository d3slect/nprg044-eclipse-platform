...
/**
 * The superclass "MultiPageEditorPart" provides the basic infrastructure,
 * such as the method "createControlPart" that calls "createPages", and it
 * takes care of the editor input.
 */
