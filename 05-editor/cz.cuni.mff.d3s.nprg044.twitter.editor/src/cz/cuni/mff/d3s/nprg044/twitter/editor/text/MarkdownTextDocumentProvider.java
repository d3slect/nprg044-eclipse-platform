...
public class MarkdownTextDocumentProvider extends FileDocumentProvider {
    ...
    /**
     * Return an IDocument object that allows to work with the actual text
     * representation of the document shown in the editor widget (control) - to
     * access lines, chars, update the current position, replace text fragments,
     * and so on.
     */
    @Override
    protected IDocument createDocument(Object element) throws CoreException {
        ...
        if (document != null) {
            IDocumentPartitioner partitioner = new FastPartitioner(new MarkdownTextPartitionScanner(),
