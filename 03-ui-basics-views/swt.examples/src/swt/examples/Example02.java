...
public class Example02 {
	...
	public static void main(String[] args) {
		...
		// position the "Cancel" button into the bottom right corner (5 points
		// margin)
		// top and left do not need to be specified, control will layout to its
		// preferred size
		formData = new FormData();
		// we define the position as 100% of parent widget height minus 5 pixels
		// offset
		...
		okButton.setText("Ok");
		// put the "OK" button to the left from the "Cancel" button with a 5
		// pixels gap
		formData = new FormData();
		formData.bottom = new FormAttachment(100, -5);
